...
struct virtio_pci {
    ...
    //Yuanguo:
    //                                          0                     1                     2                     ...        --> virt-queue number
    //      +---------------+     +---------------------+---------------------+---------------------+---------------------+
    //      | config_vector |     | vq-0的vector number | vq-1的vector number | vq-2的vector number | ...                 |  --> vector number，就是msix_table的索引
    //      +---------------+     +---------------------+---------------------+---------------------+---------------------+
    //                            u16 vq_vector[32]
    //
    //      +---------------+     +---------------------+---------------------+---------------------+---------------------+
    //      | config_gsi    |     | vq-0的gsi           | vq-1的gsi           | vq-2的gsi           | ...                 |  --> gsi 
    //      +---------------+     +---------------------+---------------------+---------------------+---------------------+
    //                            u32 gsis[32]
    //
    //      +---------------------+---------------------+---------------------+---------------------+---------------------+
    //      | config-q的中断路由  | vq-0的中断路由      | vq-1的中断路由      | vq-2的中断路由      | ...                 |  --> 中断路由信息，用于初始化中断路由表irq_routing 
    //      +---------------------+---------------------+---------------------+---------------------+---------------------+
    //      struct msix_table  msix_table[33]
