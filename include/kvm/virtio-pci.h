...
struct virtio_pci {
    ...
    //                                          0                     1                     2                     ...        --> queue number
    //      +---------------+     +---------------------+---------------------+---------------------+---------------------+
    //      | config_vector |     | q-0的vector number  | q-1的vector number  | q-2的vector number  | ...                 |  --> queue的vector number，就是msix_table的索引
    //      +---------------+     +---------------------+---------------------+---------------------+---------------------+
    //                            u16 vq_vector[32]
    //
    //      +---------------+     +---------------------+---------------------+---------------------+---------------------+
    //      | config_gsi    |     | q-0的gsi            | q-1的gsi            | q-2的gsi            | ...                 |  --> gsi
    //      +---------------+     +---------------------+---------------------+---------------------+---------------------+
    //                            u32 gsis[32]
    //
    //      +---------------------+---------------------+---------------------+---------------------+---------------------+
    //      | config-q的中断路由  | q-0的中断路由       | q-1的中断路由       | q-2的中断路由       | ...                 |  --> 中断路由信息，用于初始化中断路由表irq_routing
    //      +---------------------+---------------------+---------------------+---------------------+---------------------+
